---
title: 'Email'
excerpt: 'Email rendering and routing with React Email and SendGrid&rsquo;s API.'
icon: ''
...
The email currently in use has one image in it. The recipient&rsquo;s email client has the ability to use a lightweight and infinitely scalable SVG or a PNG.
...
Emails are sent in both HTML and plain text for clients that can&rsquo;t render HTML.
