...
function getNodeOS() {
  var platform = os__default["default"].platform() || 'linux';
  var version = os__default["default"].release() || '0.0.0';
  var platformMap = {
    android: 'Android',
    aix: 'Linux',
    darwin: 'macOS',
...
function errorHandler(errorResponse) {
  ...
  if (!lodash.isPlainObject(response) || !lodash.isPlainObject(config)) {
    throw errorResponse;
  }
  ...
  if (data && lodash.isPlainObject(data)) {
