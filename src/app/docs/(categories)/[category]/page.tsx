          ...
          <MDXRemote
            ...
            components={{
              h2: ({ children }: { children?: ReactNode }) => (
                <H2 header={children} base={props.params.category} />
              ),
              h3: ({ children }: { children?: ReactNode }) => (
                <H3 header={children} base={props.params.category} />
              ),
            }}
          />
        </div>
          ...
          <ul className='max-h-[calc(75dvh-110px)] overflow-y-auto prose prose-headings:font-black'>
            <MDXRemote
              ...
              components={{
                ...
                h2: ({ children }: { children?: ReactNode }) => (
                  <TOC2 header={children} base={props.params.category} />
                ),
                h3: ({ children }: { children?: ReactNode }) => (
                  <TOC3 header={children} base={props.params.category} />
                ),
              }}
            />
          </ul>
